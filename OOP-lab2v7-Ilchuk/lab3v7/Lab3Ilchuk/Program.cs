...
namespace Lab3Ilchuk
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                vehicle.DisplayInfo();
                Console.WriteLine($"Витрати палива на 200 км: {vehicle.CalculateFuelCost(200)} л");
                Console.WriteLine();
            }
            ...
            myCar = null;
            myMoto = null;
            GC.Collect(); // Виклик сборщика сміття
            Console.WriteLine("\nДеструктори викликано (після GC.Collect). Натисніть будь-яку клавішу для завершення.");
            Console.ReadKey();
        }
    }
}